...
class _MultiSelectDialogState<V> extends State<MultiSelectDialog<V>> {
  ...
  void initState() {
    ...
    if (widget.initialSelectedValues != null) {
      _selectedValues.addAll(widget.initialSelectedValues as List);
    }
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: <Widget>[
        FlatButton(
          child: Text(widget.cancelButtonLabel as String),
          onPressed: _onCancelTap,
        ),
        FlatButton(
          child: Text(widget.okButtonLabel as String),
  ...
  Widget _buildItem(MultiSelectDialogItem<V> item) {
    ...
    return CheckboxListTile(
      ...
      onChanged: (checked) => _onItemCheckedChange(item.value, checked as bool),
    );
  }
}
